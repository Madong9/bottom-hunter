...
个股名义满分 11 分：超跌 2、恐慌抛售 2、拒绝创新低 2、支撑位 1、板块宽度 1、基本面 2、时间窗口 1。支撑位取目标日之前历史摆动低点（可选叠加恐慌低点锚），当日回踩支撑区间并收于其上记 1 分。基本面为 `N/A` 时显示为 `x/9`，信号最高限制在 `EARLY REVERSAL`；用户补入可靠数据后才恢复 11 分评价。
